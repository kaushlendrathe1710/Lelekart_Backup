...
const ShiprocketDashboard = lazy(() => import('./pages/admin/shiprocket-dashboard'));
const ShiprocketPendingShipments = lazy(() => import('./pages/admin/shiprocket-pending-shipments'));
                          ...
                          return (
                            <div className="min-h-screen flex flex-col">
                              ...
                              <main className="flex-grow">
                                <div className="subcategory-page-container" key={componentKey}>
