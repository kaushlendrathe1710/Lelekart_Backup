...
export default function HomePage() {
  ...
  const { data, isLoading } = useQuery({
    ...
    queryFn: async ({ queryKey }) => {
      ...
      const url = `/api/products?page=${params.page}&limit=${params.limit}${params.category ? `&category=${params.category}` : ''}&approved=true&hideDrafts=true&hideRejected=true&_=${cacheBuster}`;
