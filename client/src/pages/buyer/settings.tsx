    ...
    if (userNotificationPreferences) {
      ...
      if (userNotificationPreferences.communicationPreference) {
        setCommunicationPreference(
          userNotificationPreferences.communicationPreference
        );
      }
      ...
      notificationForm.reset({
        ...
        recommendationAlerts:
          userNotificationPreferences.recommendationAlerts ?? true,
                          ...
                          render={({ field }) => (
                            <FormItem>
                              ...
                              <p className="text-xs text-muted-foreground">
                                Enter a 10-digit mobile number starting with 6,
                                7, 8, or 9
                              </p>
                              <FormMessage />
                            </FormItem>
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-muted-foreground mt-1">
                          Your account is secured with email OTP authentication.
                          For account security, we send a one-time verification
                          code to your email whenever you sign in.
                        </p>
                      </div>
                    </div>
                  ...
                  <div className="rounded-lg border p-6">
                    ...
                    <ul className="space-y-2 text-sm">
                      ...
                      <li className="flex items-start gap-2">
                        ...
                        <span>
                          Ensure you can always access your verification email
                        </span>
                      </li>
                      <li className="flex items-start gap-2">
                        <div className="h-5 w-5 rounded-full bg-primary/10 text-primary flex items-center justify-center flex-shrink-0 mt-0.5">
                            ...
                            render={({ field }) => (
                              <FormItem className="flex items-center justify-between space-y-0 rounded-lg border p-4">
                                <div className="space-y-0.5">
                                  ...
                                  <FormDescription className="text-xs">
                                    Notifications when prices drop on your
                                    wishlist items
                                  </FormDescription>
                                </div>
                                <FormControl>
                            ...
                            render={({ field }) => (
                              <FormItem className="flex items-center justify-between space-y-0 rounded-lg border p-4">
                                <div className="space-y-0.5">
                                  ...
                                  <FormDescription className="text-xs">
                                    Notifications when out-of-stock items become
                                    available
                                  </FormDescription>
                                </div>
                                <FormControl>
