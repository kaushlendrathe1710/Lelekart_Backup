...
export default function SellerShippingPage() {
  ...
  const { data: shippingSettings, isLoading: isLoadingSettings } = useQuery({
    queryKey: ['/api/seller/shipping-settings'],
    queryFn: async () => {
      try {
  ...
  const { data: shippingMethods, isLoading: isLoadingMethods } = useQuery({
    ...
    queryFn: async () => {
      try {
        ...
        return [
          { id: 1, name: "Standard Shipping", price: 4000, estimatedDays: "3-5 business days" },
          { id: 2, name: "Express Shipping", price: 9000, estimatedDays: "1-2 business days" },
          { id: 3, name: "Economy Shipping", price: 2900, estimatedDays: "5-8 business days" },
        ];
      }
    }
  });
    ...
    queryFn: async () => {
      try {
        ...
        return [
          ...
          { id: 2, name: "North India", description: "Northern states of India" },
          { id: 3, name: "South India", description: "Southern states of India" },
          { id: 4, name: "Metro Cities", description: "Major metropolitan cities" },
        ];
      }
    }
  });
  ...
  const { data: productOverrides, isLoading: isLoadingOverrides } = useQuery({
    queryKey: ['/api/seller/product-shipping-overrides'],
    queryFn: async () => {
      try {
  ...
  const productOverrideForm = useForm<z.infer<typeof productShippingOverrideSchema>>({
  ...
  useEffect(() => {
    if (selectedProduct) {
      ...
      productOverrideForm.reset({
        ...
        additionalProcessingDays: existingOverride?.additionalProcessingDays || 0,
  ...
  const saveShippingSettingsMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['/api/seller/shipping-settings'] });
      toast({
  ...
  const saveProductOverrideMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['/api/seller/product-shipping-overrides'] });
      toast({
  ...
  const onSubmitGeneralSettings = (values: z.infer<typeof shippingSettingsSchema>) => {
    saveShippingSettingsMutation.mutate(values);
  };

  // Handle product override form submission
  const onSubmitProductOverride = (values: z.infer<typeof productShippingOverrideSchema>) => {
        ...
        <div className="space-y-6">
          <div className="flex justify-between items-center">
            <div>
              ...
              <p className="text-muted-foreground">
                Configure your shipping settings and product-specific overrides
              </p>
            </div>
            <Button 
          ...
          <Tabs defaultValue="general" value={activeTab} onValueChange={setActiveTab}>
            ...
            <TabsContent value="general">
              <Card>
                <CardHeader>
                  <CardTitle>Shipping Settings Overview</CardTitle>
                  <CardDescription>
                    Your current shipping configuration and policies
                  </CardDescription>
                </CardHeader>
                <CardContent>
                  {isLoadingSettings ? (
                    ...
                    <div className="space-y-6">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              <h3 className="font-medium">Default Shipping Method</h3>
                              <p className="text-sm text-muted-foreground">
                                {isLoadingMethods ? (
                                  "Loading..."
                                ) : (
                                  findShippingMethod(shippingSettings?.defaultShippingMethodId || 1)?.name || "Standard Shipping"
                                )}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                {shippingSettings?.processingTime || "1-2 business days"}
                              </p>
                            </div>
                          </div>
                          ...
                          <div className="flex items-start gap-3">
                            ...
                            <div>
                              ...
                              <p className="text-sm text-muted-foreground">
                                {shippingSettings?.internationalShipping ? "Enabled" : "Disabled"}
                              </p>
                            </div>
                          </div>
                        </div>
                          ...
                          <div>
                            ...
                            <div className="mt-2 p-3 bg-muted rounded-md text-sm">
                              {shippingSettings?.shippingPolicy ? (
                                ...
                                <p className="text-muted-foreground italic">No shipping policy set</p>
                              )}
                            </div>
                          </div>
                          ...
                          <div>
                            ...
                            <div className="mt-2 p-3 bg-muted rounded-md text-sm">
                              {shippingSettings?.returnPolicy ? (
                                ...
                                <p className="text-muted-foreground italic">No return policy set</p>
                              )}
                            </div>
                          </div>
                        </div>
                      ...
                      <div className="bg-blue-50 border border-blue-100 rounded-md p-4 flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-medium text-blue-700">Shipping Tips</h3>
                          <ul className="mt-2 space-y-1 text-sm text-blue-600 list-disc pl-4">
                            <li>Clear shipping policies help set customer expectations</li>
                            <li>Consider offering free shipping for orders above a threshold to increase average order value</li>
                            <li>Set realistic processing times to avoid customer disappointment</li>
                            <li>Different shipping zones may require different shipping methods</li>
                          </ul>
                        </div>
                      </div>
                    </div>
            ...
            <TabsContent value="products">
              <Card>
                <CardHeader>
                  <CardTitle>Product Shipping Overrides</CardTitle>
                  <CardDescription>
                    ...
                    <div className="space-y-4">
                      ...
                      {productOverrides?.length > 0 ? (
                                ...
                                return (
                                  <TableRow key={override.id}>
                                    <TableCell className="font-medium">
                                      {product ? product.name : `Product #${override.productId}`}
                                    </TableCell>
                                    <TableCell>
                                      {override.customPrice ? formatPrice(override.customPrice) : "Default"}
                                    </TableCell>
                                    <TableCell>
                        ...
                        <div className="text-center py-8 border rounded-md bg-muted/40">
                          ...
                          <h3 className="mt-4 font-medium">No Product Overrides</h3>
                          <p className="text-sm text-muted-foreground mt-1">
                            You haven't set up any product-specific shipping overrides yet
                          </p>
                          <Button 
                            onClick={() => setIsProductOverrideDialogOpen(true)} 
                            variant="outline" 
                            className="mt-4"
                          >
                      ...
                      <div className="bg-amber-50 border border-amber-100 rounded-md p-4 flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-medium text-amber-700">When to Use Product Overrides</h3>
                          <ul className="mt-2 space-y-1 text-sm text-amber-600 list-disc pl-4">
                            <li>For oversized or unusually heavy products that cost more to ship</li>
                            <li>For fragile items that require special handling</li>
                            <li>To offer free shipping on select products as a promotion</li>
                            <li>For products that require longer processing time</li>
                          </ul>
                        </div>
                      </div>
                    </div>
                  ...
                  {isLoadingMethods ? (
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="bg-green-50 border border-green-100 rounded-md p-4 flex items-start gap-3">
                        ...
                        <div>
                          <h3 className="font-medium text-green-700">About Shipping Methods</h3>
                          <p className="mt-1 text-sm text-green-600">
                            These shipping methods are available platform-wide. You can set your default 
                            shipping method in the general settings. The actual shipping cost for customers 
                            may vary based on shipping zones and your product-specific overrides.
                          </p>
                          <p className="mt-2 text-sm text-green-600">
                            Need a custom shipping method for your store? Contact our support team.
                          </p>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        {shippingZones?.map((zone: any) => (
                          <Card key={zone.id} className="border border-gray-200 shadow-sm">
                            <CardHeader className="pb-2">
                              <CardTitle className="text-base flex items-center gap-2">
                              ...
                              <div className="space-y-3 text-sm">
                                {zone.countries && (
                                  <div>
                                    ...
                                    <span className="ml-2">{zone.countries}</span>
                                  </div>
                                )}
                                {zone.states && (
                                  <div>
                                ...
                                {zone.zipCodes && (
                                  <div>
                                    ...
                                    <span className="ml-2">{zone.zipCodes}</span>
                                  </div>
                                )}
                              </div>
                            </CardContent>
                      ...
                      <div className="bg-purple-50 border border-purple-100 rounded-md p-4 flex items-start gap-3">
                        ...
                        <div>
                          ...
                          <p className="mt-1 text-sm text-purple-600">
                            Shipping zones allow for different shipping rates and methods depending on the
                            delivery location. The platform has pre-configured these zones based on common
                            shipping regions in India.
                          </p>
                          <p className="mt-2 text-sm text-purple-600">
                            Note that shipping costs and delivery estimates may vary by zone. You can view
                            the exact shipping costs for each zone and method in the shipping settings.
                          </p>
                        </div>
                      </div>
                    </div>
                        ...
                        <SelectContent>
                          {shippingMethods?.map((method: any) => (
                            <SelectItem key={method.id} value={method.id.toString()}>
                              {method.name} ({formatPrice(method.price)}, {method.estimatedDays})
                            </SelectItem>
                          ))}
                        </SelectContent>
                      </Select>
                      <FormDescription>
                        This will be the default shipping method for all your products
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Orders above this amount will qualify for free shipping (0 = no free shipping)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormControl>
                        <Input {...field} placeholder="e.g., 1-2 business days" />
                      </FormControl>
                      <FormDescription>
        ...
        <Dialog open={isProductOverrideDialogOpen} onOpenChange={setIsProductOverrideDialogOpen}>
          <DialogContent className="max-w-2xl">
            ...
            <Form {...productOverrideForm}>
              <form onSubmit={productOverrideForm.handleSubmit(onSubmitProductOverride)} className="space-y-4">
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Choose the product you want to set special shipping options for
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      <FormLabel>Custom Shipping Price (₹, in paise/cents)</FormLabel>
                      <FormControl>
                        <Input
                          type="number"
                          {...field}
                      ...
                      <FormDescription>
                        Override the default shipping price for this product (0 = use default price)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Extra days needed to process this product (0 = no extra days)
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
                ...
                <FormField
                  ...
                  render={({ field }) => (
                    <FormItem>
                      ...
                      <FormDescription>
                        Any shipping restrictions or special notes for this product
                      </FormDescription>
                      <FormMessage />
                    </FormItem>
                  )}
