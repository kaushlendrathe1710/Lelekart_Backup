...
export default function SellerShippingPage() {
  ...
  const saveShippingSettingsMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['/api/seller/shipping-settings', user?.id] });
      toast({
  ...
  const saveProductOverrideMutation = useMutation({
    ...
    onSuccess: () => {
      queryClient.invalidateQueries({ queryKey: ['/api/seller/product-shipping-overrides', user?.id] });
      toast({
