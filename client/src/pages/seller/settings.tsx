  ...
  const savePickupAddress = async () => {
    ...
    try {
      ...
      toast({
        ...
        description: "Your pickup address has been updated successfully. This address will be used on invoices.",
      });
    } catch (error) {
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => {
                          ...
                          const value = e.target.value.replace(/[^0-9]/g, '');
                          e.target.value = value;
                          setPersonalInfo({...personalInfo, alternatePhone: value});
                        }}
                      />
                      <p className="text-xs text-muted-foreground">
                        Enter a 10-digit number without spaces or special characters
                ...
                <CardContent className="space-y-4">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        onChange={async (e) => {
                          ...
                          if (pincode.length === 6) {
                            ...
                            try {
                              ...
                              console.log("Pincode API response:", response.status);
                              if (response.ok) {
                                const data = await response.json();
                                console.log("Pincode data received:", data);
                                if (data && data.state) {
                                  console.log("Setting address with pincode data:", data.state, data.district);
                                  setAddress(prev => ({
                                    ...prev,
                                    pincode,
                    ...
                    <div className="space-y-2">
                      ...
                      />
                      <p className="text-xs text-muted-foreground">Auto-populated from PIN code</p>
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => {
                          ...
                          const value = e.target.value.replace(/[^0-9]/g, '');
                          e.target.value = value;
                          setStoreSettings({...storeSettings, contactPhone: value});
                        }}
            ...
            <TabsContent value="pickup_address" className="space-y-6 mt-0">
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Set your business pickup address for invoices and shipping labels</CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setPickupAddress({...pickupAddress, businessName: e.target.value})}
                      />
                    </div>
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => setPickupAddress({...pickupAddress, gstin: e.target.value})}
                      />
                    </div>
                    <div className="space-y-2">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={(e) => {
                          ...
                          const value = e.target.value.replace(/[^0-9]/g, '');
                          e.target.value = value;
                          setPickupAddress({...pickupAddress, phone: value});
                        }}
                      />
                      <p className="text-xs text-muted-foreground">
                        Enter a 10-digit number without spaces or special characters
                  ...
                  <div className="space-y-2 mt-4">
                    ...
                    <Input 
                      ...
                      onChange={(e) => setPickupAddress({...pickupAddress, line1: e.target.value})}
                    />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="pickupLine2">Address Line 2 (Optional)</Label>
                    <Input 
                      id="pickupLine2" 
                      value={pickupAddress.line2}
                      onChange={(e) => setPickupAddress({...pickupAddress, line2: e.target.value})}
                    />
                  </div>
                    ...
                    <div className="space-y-2">
                      ...
                      <Input 
                        ...
                        onChange={async (e) => {
                          ...
                          // If pincode is 6 digits, try to auto-populate city and state
                          if (pincode.length === 6) {
                            console.log("Fetching data for pickup pincode:", pincode);
                            try {
                              const response = await fetch(`/api/pincode/${pincode}`);
                              console.log("Pickup Pincode API response:", response.status);
                              if (response.ok) {
                                const data = await response.json();
                                console.log("Pickup Pincode data received:", data);
                                if (data && data.state) {
                                  console.log("Setting pickup address with pincode data:", data.state, data.district);
                                  ...
                                  console.log("Pickup address state updated:", pickupAddress.state, pickupAddress.city);
                                }
                              }
                            } catch (error) {
                              console.error("Error fetching pincode data:", error);
