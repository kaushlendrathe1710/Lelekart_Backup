...
export default function SellerDashboardPage() {
  ...
  const { data: dashboardSummary, isLoading: isLoadingSummary, error: summaryError } = useQuery<DashboardSummary>({
          ...
          {summaryError && (
            <Alert variant="destructive" className="mb-6">
              ...
              <AlertDescription className="mt-2">
                We encountered an error while loading your dashboard data. This may be a temporary issue.
                <div className="mt-3">
                  <Button 
                    variant="outline" 
                    size="sm"
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  {isLoadingSummary ? (
                    ...
                    <p className="text-2xl font-bold">{dashboardSummary?.totalProducts || 0}</p>
                  )}
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  {isLoadingSummary ? (
                    ...
                    <p className="text-2xl font-bold">{dashboardSummary?.totalOrders || 0}</p>
                  )}
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  {isLoadingSummary ? (
                    ...
                    <p className="text-2xl font-bold">₹{dashboardSummary?.totalRevenue?.toFixed(2) || '0'}</p>
                  )}
                </div>
              ...
              <div className="flex items-center justify-between">
                <div>
                  ...
                  {isLoadingSummary ? (
                    ...
                    <p className="text-2xl font-bold">₹{dashboardSummary?.avgPrice?.toFixed(2) || '0'}</p>
                  )}
                </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between border-b pb-2">
                    <span className="text-sm text-muted-foreground">Top Selling Products</span>
          ...
          <CardContent>
            <div className="space-y-3">
              ...
              <div className="flex items-start gap-3 p-3 bg-orange-50 rounded-md">
                ...
                <div>
                  <p className="text-sm font-medium">Seller Performance Review</p>
                  <p className="text-xs text-muted-foreground">June 1, 2025</p>
                  <p className="text-xs mt-1">
                    Quarterly seller performance review. Maintain good metrics to qualify for benefits.
                  </p>
                </div>
              </div>
            </div>
