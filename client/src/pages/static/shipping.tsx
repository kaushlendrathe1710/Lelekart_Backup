...
export default function ShippingPage() {
  ...
  return (
    <StaticPageTemplate 
      ...
      subtitle="Information about our shipping options, delivery times, and policies"
    >
      <StaticPageSection 
        ...
        defaultContent={
          <div className="mb-8 text-gray-700">
            <p className="text-lg">
              At Lelekart, we're committed to delivering your orders quickly, safely, and reliably. 
              We offer various shipping options to meet your needs and partner with trusted logistics 
              providers to ensure your packages reach you in perfect condition.
            </p>
          </div>
        }
      />
          ...
          <CardContent className="p-6">
            <div className="flex flex-col md:flex-row items-center gap-4">
              <div className="flex-grow">
                ...
                <p className="text-gray-600 mb-4">Enter your PIN code to check delivery availability, shipping options, and estimated delivery time in your area.</p>
                <div className="flex">
                  <Input
      ...
      {/* Shipping Options */}
      <div className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-[#2874f0]">Shipping Options</h2>
        <StaticPageSection 
          section="shipping_page"
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Card className="border-[#efefef] hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 text-center">
                    Our standard shipping option. Available for most areas across India with 
                    reliable delivery within 2-4 business days.
                  </p>
              ...
              <Card className="border-[#efefef] hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  ...
                  <p className="text-gray-600 text-center">
                    Get your order delivered by the next business day. Available for select 
                    pincodes in major cities across India.
                  </p>
                  <div className="text-center mt-4">
                    <p className="font-medium text-green-600">
                      FREE for all orders
              ...
              <Card className="border-[#efefef] hover:shadow-md transition-shadow">
                <CardContent className="p-6">
                  <div className="flex flex-col items-center text-center mb-4">
                    <div className="bg-[#2874f0]/10 w-16 h-16 flex items-center justify-center rounded-full mb-4">
                      <CalendarCheck size={28} className="text-[#2874f0]" />
                    </div>
                    <h3 className="text-lg font-semibold">Scheduled Delivery</h3>
                    <p className="text-sm text-gray-500">Choose your delivery date</p>
                  </div>
                  <p className="text-gray-600 text-center">
                    Select your preferred delivery date and time slot. Ideal for planned 
                    purchases or gifts for special occasions.
                  </p>
                  <div className="text-center mt-4">
                    <p className="font-medium text-green-600">
                      FREE for all orders
      ...
      {/* Shipping Locations */}
      <div className="mb-12">
        <h2 className="text-2xl font-bold mb-6 text-[#2874f0]">Shipping Coverage</h2>
        <StaticPageSection 
          section="shipping_page"
          ...
          defaultContent={
            <Tabs defaultValue="domestic" className="w-full">
              ...
              <TabsContent value="domestic">
                <div className="space-y-6">
                  <p className="text-gray-700">
                    We currently deliver to over 19,000 pincodes across India, covering 
                    all major cities and most rural areas.
                  </p>
                  ...
                  <div className="p-4 border border-yellow-200 bg-yellow-50 rounded-md text-yellow-800 text-sm">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p>Some remote locations may have longer delivery times and limited shipping options. Check availability for your specific pincode using the tool above.</p>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <TabsContent value="international">
                <div className="space-y-6">
                  <p className="text-gray-700">
                    We currently don't offer direct international shipping. However, you can use our partners for international delivery.
                  </p>
                  
                  <Card className="border-[#efefef]">
                    <CardContent className="p-6">
                      <h3 className="font-semibold mb-4">International Shipping Partners</h3>
                      <p className="text-gray-600 mb-4">
                        For international shipping, you can use the following shipping forwarders who partner with us:
                      </p>
                      <ul className="space-y-3">
                        <li className="flex items-start">
                          ...
                          <div>
                            <p className="font-medium">ShipIndia Global</p>
                            <p className="text-sm text-gray-600">Ships to 100+ countries. Register with them and use their Indian address for delivery.</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <div className="bg-[#2874f0]/10 w-8 h-8 flex items-center justify-center rounded-full mr-3 flex-shrink-0">
                          ...
                          <div>
                            <p className="font-medium">IndiaPost International</p>
                            <p className="text-sm text-gray-600">Official postal service with international shipping available to most countries.</p>
                          </div>
                        </li>
                        <li className="flex items-start">
                          <div className="bg-[#2874f0]/10 w-8 h-8 flex items-center justify-center rounded-full mr-3 flex-shrink-0">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-gray-600">Specialized in shipping Indian products worldwide with customs clearance assistance.</p>
                          </div>
                        </li>
                      </ul>
                      <p className="text-sm text-gray-600 mt-4">
                        Please contact these partners directly for shipping rates, delivery times, and specific country availability.
                      </p>
                    </CardContent>
                  </Card>
                </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-10">
        <div>
          <h2 className="text-2xl font-bold mb-6 text-[#2874f0]">Order Tracking</h2>
          <StaticPageSection 
            section="shipping_page"
                  ...
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      ...
                      <ul className="space-y-2">
                        ...
                        <li className="flex items-center text-gray-700">
                          <div className="w-1.5 h-1.5 rounded-full bg-[#2874f0] mr-2"></div>
                          SMS notifications to your registered mobile number
                        </li>
                        <li className="flex items-center text-gray-700">
                          <div className="w-1.5 h-1.5 rounded-full bg-[#2874f0] mr-2"></div>
        ...
        <div>
          <h2 className="text-2xl font-bold mb-6 text-[#2874f0]">Shipping Policies</h2>
          <StaticPageSection 
            section="shipping_page"
              ...
              <Card className="border-[#efefef] h-full">
                <CardContent className="p-6">
                  <div className="flex items-start mb-4">
                    ...
                    <div>
                      <h3 className="font-semibold mb-1">Our Policies</h3>
                      <p className="text-gray-600 mb-3">
        ...
        defaultContent={
          <div className="bg-gray-50 rounded-lg p-6 text-center mt-10">
            ...
            <p className="text-gray-600 max-w-3xl mx-auto mb-6">
              ...
              about shipping options, delivery times, or tracking your order.
            </p>
