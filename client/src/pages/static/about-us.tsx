              ...
              <div className="flex flex-col md:flex-row">
                <div className="md:w-2/3 pr-0 md:pr-8 mb-6 md:mb-0">
                  <AboutPageSection
                    ...
                    defaultContent={
                      <>
                        <h2 className="text-xl md:text-2xl font-bold mb-4 text-[#2874f0]">
                          The LeleKart Group
                        </h2>
                ...
                <div className="md:w-1/3">
                  <div className="bg-gray-100 rounded-lg p-4">
                    <AboutPageSection
                      ...
                      defaultContent={
                        <>
                          <h3 className="text-lg font-semibold mb-3 text-[#2874f0]">
                  ...
                  defaultContent={
                    <>
                      ...
                      <div className="flex flex-col sm:flex-row gap-4 justify-center">
                        <a
                          href="/careers"
                          className="bg-[#2874f0] text-white px-6 py-2 rounded-sm hover:bg-[#2363cc] transition-colors"
                        >
                          Explore Careers
                        </a>
                        <a
                          href="/seller"
                          className="bg-white text-[#2874f0] border border-[#2874f0] px-6 py-2 rounded-sm hover:bg-[#f5f9ff] transition-colors"
                        >
                          Become a Seller
                        </a>
                      </div>
                  ...
                  <div className="border border-gray-200 rounded-md">
                    <details className="group">
                      <summary className="flex items-center justify-between cursor-pointer p-4">
                        ...
                        <span className="text-[#2874f0] font-bold group-open:rotate-180 transition-transform">
                          +
                        </span>
                      </summary>
