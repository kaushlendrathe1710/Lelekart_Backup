          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormField
                ...
                render={({ field }) => (
                  <FormItem>
                    <FormLabel>Total Work Experience (Years)</FormLabel>
                    <FormControl>
                      <Input
                        type="number"
                        placeholder="e.g., 2"
                  ...
                  <FormItem>
                    ...
                    <Select
                      onValueChange={(value) => {
                        ...
                        if (selectedCountry) {
                          setValue("phoneCode", selectedCountry.dialCode);
                          setValue("whatsappCode", selectedCountry.dialCode);
                        }
                      }}
                      value={field.value}
                    >
                    ...
                    <div className="mt-1 flex rounded-md shadow-sm">
                      <div className="relative flex items-stretch flex-grow">
                        <div className="absolute inset-y-0 left-0 flex items-center">
                          <span className="text-gray-500 sm:text-sm pl-3 pr-2 border-r border-gray-300">
                            {watch("phoneCode") || "+91"}
                          </span>
                        </div>
                        <Input
