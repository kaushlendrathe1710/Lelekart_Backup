...
export default function AdminLayout({ children }: AdminLayoutProps) {
  ...
  const menuItems = [
    ...
    { path: '/admin/orders', label: 'Orders', icon: <FileText className="h-5 w-5" /> },
    { path: '/admin/users', label: 'Users', icon: <Users className="h-5 w-5" /> },
    { path: '/admin/sellers', label: 'Sellers', icon: <Users className="h-5 w-5" /> },
    { path: '/admin/categories', label: 'Categories (Old)', icon: <Box className="h-5 w-5" /> },
    { path: '/admin/category-management', label: 'Category Management', icon: <Box className="h-5 w-5" /> },
    { path: '/admin/shipping', label: 'Shipping', icon: <Truck className="h-5 w-5" /> },
    { path: '/admin/returns', label: 'Returns', icon: <RefreshCw className="h-5 w-5" /> },
    { path: '/admin/analytics', label: 'Analytics', icon: <BarChart3 className="h-5 w-5" /> },
    { path: '/admin/backups', label: 'Backups', icon: <Database className="h-5 w-5" /> },
