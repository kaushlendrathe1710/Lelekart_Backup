                ...
                <DropdownMenuContent align="end">
                  <div className="flex items-center justify-start gap-2 p-2">
                    <div className="flex flex-col space-y-1 leading-none">
                      ...
                      <p className="text-xs font-semibold text-orange-500">Seller Account</p>
                    </div>
                  </div>
            ...
            <SidebarHeader className="border-b">
              <div className="flex items-center gap-2 px-3 py-3">
                <Avatar className="h-10 w-10 border border-gray-200">
                  ...
                  <AvatarFallback className="bg-orange-100 text-orange-600">{getInitials(user.username)}</AvatarFallback>
                </Avatar>
                <div className="flex flex-col">
                  <span className="font-medium leading-none">{user.username}</span>
                  <span className="text-xs text-orange-600">Seller Account</span>
                </div>
              </div>
            </SidebarHeader>
            <SidebarContent>
