    ...
    <div className="bg-white shadow-sm">
      <div className="container mx-auto">
        <div className="flex overflow-x-auto py-2 px-4 md:px-0 md:justify-between">
          ...
          <Link 
            href="/"
            className={`flex flex-col items-center px-4 py-1 flex-shrink-0 ${
              !activeCategory ? 'text-primary font-medium' : 'hover:text-primary'
            }`}
          >
            <div className={`w-16 h-16 rounded-full flex items-center justify-center border-2 ${
              !activeCategory ? 'border-primary' : 'border-gray-200'
            }`}>
            ...
            <span className="text-xs font-medium mt-1">All Products</span>
          </Link>
