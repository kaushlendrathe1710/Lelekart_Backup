...
export async function registerRoutes(app: Express): Promise<Server> {
  ...
  // Uses the implementation from shiprocket-routes.ts
  // app.post("/api/orders/:id/shiprocket", ...) - using orderId param version below instead
  
  // Uses the implementation from shiprocket-routes.ts
  // app.post("/api/orders/:id/shiprocket/cancel", ...) - using orderId param version below instead
  
  // Uses the implementation from shiprocket-routes.ts
  // Ensuring parameter name matches between routes (trackingNumber vs trackingId)
  app.get("/api/tracking/:trackingNumber", shiprocketRoutes.trackShiprocketOrder);
  ...
  // Using the shiprocket-routes.ts implementation instead
  // Route: app.post("/api/orders/:orderId/shiprocket", shiprocketRoutes.pushOrderToShiprocket);
